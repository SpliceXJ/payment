...
class TestCreateSpliceUser:
    ...
    payload = {"email": "testuser@gmail.com", "user_id": str(uuid.uuid4())[:20]}
    ...
    def test_create_user_with_existing_email(self):
        ...
        response = self.client.post(
            path=self.url,
            data={"email": test_user_created.email, "user_id": "new_username"},
        )
    ...
    def test_create_user_with_existing_username(self):
        ...
        response = self.client.post(
            path=self.url,
            data={"email": "newemail@gmail.com", "user_id": test_user_created.username},
        )
